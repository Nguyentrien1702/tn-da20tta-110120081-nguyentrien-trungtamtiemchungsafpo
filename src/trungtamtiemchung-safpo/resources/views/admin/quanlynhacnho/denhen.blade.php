                ...
                @else
                    ...
                    @foreach($dschotiems as $dschotiem)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/Admin/nhacnhotiem/' . $dschotiem->madk_goi . '/' . $dschotiem->mavc . '/'. $dschotiem->makh) }}" class="btn btn-primary btn-sm">
                ...
                @else
                    ...
                    @foreach($goiTiems as $dsgoitiem)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/Admin/nhacnhogoi/' . $dsgoitiem->madk_goi . '/'. $dsgoitiem->makh) }}" class="btn btn-primary btn-sm">
                                    Gửi SMS nhắc nhở
                                </a>
