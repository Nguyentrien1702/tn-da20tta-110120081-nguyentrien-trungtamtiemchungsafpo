                ...
                @else
                    ...
                    @foreach($vcles as $vcle)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/Admin/xngoidk', $vcle->madk_goi) }}" onclick="return confirm('Xác nhận đã thanh toán và đăng ký!')" class="btn btn-primary btn-sm">
                ...
                @else
                    ...
                    @foreach($vcgois as $vcgoi)
                        <tr>
                            ...
                            <td>{{ number_format($vcgoi->tonggiatien - $vcgoi->datcoc, 0, ',', '.') }}</td>
                            <td>
...
<script>
    function openModal(id) {
        ...
        $.ajax({
            url: '/Admin/gettongtien/' + id, // API endpoint or route to fetch data from server
            type: 'GET',
    ...
    function xacnhan(){
        ...
        closeModal();
        $.ajax({
            url: '/Admin/xngoidk/' + $madk_goi, // API endpoint or route to fetch data from server
            type: 'GET',
            success: function(response) {
                location.reload();
            },
