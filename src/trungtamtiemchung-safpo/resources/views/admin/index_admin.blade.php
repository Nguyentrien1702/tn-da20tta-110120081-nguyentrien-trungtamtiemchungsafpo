        ...
        <div class="mb-3" aria-label="Basic example">
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6" style="text-align: center;">
                    ...
                    <h4>Số lượng gói vaccine đăng ký và hủy theo thời gian</h4>
                </div>
                <div class="col-xl-6 col-md-6" style="text-align: center;">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.months.length; i++) {
                    chartData.push([data.months[i], data.totals[i]]);
                }

                var options = {
                    title: 'Số lượng mũi tiêm theo từng tháng',
                    curveType: 'function',
