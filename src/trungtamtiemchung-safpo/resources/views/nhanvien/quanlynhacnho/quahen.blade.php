                    ...
                    @foreach($tiemleqhs as $dschotiem)
                        <tr>
                            ...
                            <td>
                                ...
                                <a style="width: 140px;" href="{{ url('/Nhanvien/huymuitiem/' . $dschotiem->madk_goi . '/'. $dschotiem->makh) }}" onclick="return confirm('Xác nhận hủy')" class="btn btn-danger btn-sm">
                                    Hủy mũi tiêm
                                </a>
                            </td>
                        </tr>
        ...
        <div class="modal fade" id="modalCapNhatNgayTiem" tabindex="-1" aria-labelledby="modalCapNhatNgayTiemLabel" aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form id="formCapNhatNgayTiem" method="POST" action="{{ url('/Nhanvien/capnhatngaytiem') }}">
                        @csrf
                ...
                @else
                    ...
                    @foreach($goitiemqhs as $goitiemqh)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/Nhanvien/huygoi/' . $goitiemqh->madk_goi . '/'. $goitiemqh->makh) }}" onclick="return confirm('Xác nhận hủy')" class="btn btn-primary btn-sm">
                                    Hủy gói
                                </a>
