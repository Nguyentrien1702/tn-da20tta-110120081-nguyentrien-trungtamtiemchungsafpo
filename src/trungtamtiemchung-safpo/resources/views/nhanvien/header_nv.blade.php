...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="" style="font-weight: bold;">Nhân viên</a>
            <!-- Sidebar Toggle-->
                        ...
                        <li><a class="dropdown-item" href="#!">
                            @if(session('manhanvien'))
                                <div class="alert alert-success">
                                    {{ session('manhanvien') }}<br>
                                    {{ session('vaitro') }}
                                </div>
                            @endif
                        </a></li>
                        <li><a class="dropdown-item" href="{{ url('/Nhanvien/Thong-tin-nhan-vien') }}">Thông tin cá nhân</a></li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            @if (session("vaitro") == "Bác sĩ")
                             <a class="nav-link" href="{{ url('/Nhanvien/Tiem-chung') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Tiêm chủng
                            </a>
                            @endif
                            @if (session("vaitro") == "Y tá")
                            <a class="nav-link" href="{{ url('/Nhanvien/Tat-ca-lich-tiem') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Tất cả lịch tiêm
                            </a>
                            <a class="nav-link" href="{{ url('/Nhanvien/Dang-ky-tiem') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Đăng ký tiêm
                            </a>
                            <a class="nav-link" href="{{ url('/Nhanvien/Lich-tiem-cho-xn') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Quản lý gói đăng ký
                            </a>
                            <a class="nav-link" href="{{ url('/Nhanvien/Lich-hen') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Quản lý lịch hẹn
                            </a>
                            ...
                            <div class="collapse" id="nnlichtiem" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('/Nhanvien/Nhac-nho-den-hen') }}">Sắp đến hẹn</a>
                                    <a class="nav-link" href="{{ url('/Nhanvien/Nhac-nho-qua-hen') }}">Quá hẹn</a>
                                </nav>
                            </div>
                            @endif
                            ...
                            <div class="collapse" id="qlkhachhang" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('/Nhanvien/Danh-sach-khach-hang') }}">Khách hàng</a>
                            ...
                            <div class="collapse" id="qlvaccine" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('/Nhanvien/Danh-sach-vaccine') }}">Vaccine</a>                                    
                                </nav>
                            </div>
                        </div>
                    </div>
